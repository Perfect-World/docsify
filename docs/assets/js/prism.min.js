    ...
    var t = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      n = {
          ...
          clone: function e(t, a) {
            ...
            switch (((a = a || {}), i)) {
              case 'Object':
                ...
                for (var l in ((r = {}), (a[s] = r), t))
                  t.hasOwnProperty(l) && (r[l] = e(t[l], a))
                return r
              case 'Array':
                return (
                  (s = n.util.objId(t)),
        ...
        highlightAllUnder: function (e, t, a) {
          ...
          for (var s, i = e.querySelectorAll(r.selector), l = 0; (s = i[l++]); )
            n.highlightElement(s, !0 === t, r.callback)
        },
        highlightElement: function (a, r, s) {
          for (var i, l = 'none', o = a; o && !t.test(o.className); )
            o = o.parentNode
          o &&
            ((l = (o.className.match(t) || [, 'none'])[1].toLowerCase()),
            (i = n.languages[l])),
            (a.className =
            ...
            a.parentNode &&
              ...
              /pre/i.test(o.nodeName) &&
                (o.className =
                  ...
                  ' language-' +
                  l))
          var u = { element: a, language: l, grammar: i, code: a.textContent },
            c = function (e) {
              ;(u.highlightedCode = e),
        ...
        highlight: function (e, t, a) {
          var s = { code: e, grammar: t, language: a }
          return (
                ...
                for (var F = s, v = i; F < t.length; v += t[F].length, ++F) {
                  ...
                  if (!(k instanceof r)) {
                    if (f && F != t.length - 1) {
                      ...
                      for (
                        var w = S.index + (m ? S[1].length : 0),
                          A = S.index + S[0].length,
                          x = F,
                          P = v,
                          $ = t.length;
                        x < $ && (P < A || (!t[x].type && !t[x - 1].greedy));
                        ++x
                      )
                        w >= (P += t[x].length) && (++F, (v = P))
                    ...
                    if (S) {
                      ...
                      if (
                        ...
                        1 != _ && n.matchGrammar(e, t, a, F, v, !0, u),
                        l)
                      )
                        break
                    } else if (l) break
        ...
        hooks: {
          ...
          run: function (e, t) {
            var a = n.hooks.all[e]
            if (a && a.length) for (var r, s = 0; (r = a[s++]); ) r(t)
          },
        },
        Token: r,
      }
